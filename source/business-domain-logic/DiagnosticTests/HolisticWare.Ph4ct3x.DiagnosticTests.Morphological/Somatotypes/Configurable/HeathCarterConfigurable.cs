...
namespace HolisticWare.Ph4ct3x.DiagnosticTests.Morphological.SomatoTypes.Configurable
{
    ...
    /// </summary>
    public class HeathCarterConfigurable : HeathCarterBase
    {
        public HeathCarterConfigurable() : base()
        {
            Initialize();

            Configuration = HeathCarterAlgorithmConfiguration.AlgorithmConfigurations["HeathCarterEastonUniversityOfExeter"];
        ...
        public double PartEq1End
        {
            ...
            {
                return
                    this.Configuration.ConstantsAndParameters["PartEq1End 0.00068"] * (this.SkinfoldsSumCorrectedForHeight * this.SkinfoldsSumCorrectedForHeight)
                    +
                    0.0000014 * (16 ^ 3)
                    ;
                    ...
                    EctomorphicComponentHeightWeightRatioTuple()
        {
            ...
            // TODO: check
            if (HWR_weight_index >= 40.74) 
            {
                ectomprphic_height_mass_ratio_tupple.Upper = ectomprphic_tupple.Upper;
            }
            // TODO: check this!! 
            if ( 36.95 < HWR_weight_index && HWR_weight_index < 40.75 ) // 38.25)
            {
