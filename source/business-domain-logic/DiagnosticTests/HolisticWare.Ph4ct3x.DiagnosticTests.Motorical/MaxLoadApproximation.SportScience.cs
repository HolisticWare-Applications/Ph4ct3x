...
namespace HolisticWare.Ph4ct3x.DiagnosticTests.Motorical
{
    ...
    public partial class MaxLoadApproximation
    {
                                    ...
                                    )
        {
            ...
            double max_load = (100 * mass) / (101.3d - 2.67123d * number_of_repetitions);
                                    ...
                                    )
        {
            ...
            double max_load = 
                (100.0 * mass) 
                / 
                (48.8 + 53.8 * System.Math.Pow(System.Math.E, -0.075 * number_of_repetitions))
                ;
        ...
        {
            // 1RM = W x R^0.1
            double max_load = mass * System.Math.Pow(number_of_repetitions, 0.1);
                                    ...
                                    )
        {
            ...
            double max_load =
                100.0 * mass
                /
                (52.2 + 41.9 * System.Math.Pow(System.Math.E, -0.055 * number_of_repetitions))
                ;
        ...
        {
            // 1RM = W x (1 + 0.025 x R)
            double max_load = mass * (1.0 + (double_0_025_1_over_40_OConner * number_of_repetitions)); ;
