...
namespace HolisticWare.Ph4ct3x.DiagnosticTests.Motorical
{
    ...
    {
        private double max_load_1rm;

        public double MaxLoad1RM
        {
            get
            {
                return max_load_1rm;
        ...
        public ulong? NumberOfRepetitions
        {
            get;
            set;
        }

        private const double double_0_033_AKA_1_over_30_Epley = 0.033;
        private const double double_0_025_1_over_40_OConner = 0.025;
        ...
        {
            Dictionary<string, double> max_load_approximations = new Dictionary<string, double>()
            {
                {
                    "Epley (Wikipedia)",
                ...
                {
                    "Bryzicky (SportScience)", 
                    this.CalculateBrzycki_SportScience(mass,number_of_repetitions)
                },
                {
                    "Epley (BrianMac)", 
                ...
                {
                    "Lander (SportScience)", 
                    this.CalculateLander_SportScience_Landers_BrianMac(mass,number_of_repetitions)
                },
                {
                    "Landers (BrianMac)",
                    this.CalculateLander_SportScience_Landers_BrianMac(mass,number_of_repetitions)
